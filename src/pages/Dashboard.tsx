  ...
  const allActivities = [
    {
      name: "Mathi MS.",
      action: "reviewed",
      target: "5 code submissions",
      initials: "MR",
      icon: <Code size={16} className="text-[#00bf53]" />,
    },
    {
      name: "Sarah K.",
      action: "completed",
      ...
      initials: "SK",
      icon: <BookOpen size={16} className="text-[#00bf53]" />,
    },
    {
      name: "Tom B.",
      action: "posted",
      target: "a helpful tip for Ai",
      initials: "TB",
      icon: <MessageCircle size={16} className="text-[#00bf53]" />,
    },
    {
      name: "Emma W.",
      action: "submitted",
      target: "Weekly Challenge",
      initials: "EW",
      icon: <Trophy size={16} className="text-[#00bf53]" />,
    },
    {
      name: "James L.",
      action: "completed",
      target: "TypeScript Basics",
      initials: "JL",
      icon: <BookOpen size={16} className="text-[#00bf53]" />,
    },
    {
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              Welcome back! Connect with fellow alumni and explore career
              opportunities.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900">Network Events</h3>
                <p className="text-sm text-blue-700">
                  Join upcoming alumni meetups
                </p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="font-medium text-purple-900">Mentorship</h3>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="p-3 bg-blue-50 hover:bg-blue-100 rounded-lg text-left transition-colors">
              <Settings size={16} className="text-blue-600 mb-2" />
              <div className="text-sm font-medium text-blue-900">Settings</div>
            </button>
            <button className="p-3 bg-green-50 hover:bg-green-100 rounded-lg text-left transition-colors">
              <Users size={16} className="text-green-600 mb-2" />
      ...
      <div className="max-w-[calc(100vw-450px)] mx-auto px-6 space-y-6 py-6 relative">
            ...
            <div className="mt-0 flex gap-4">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200 ">
                    ...
                    <div className="text-center">
                      <div className="text-xs text-[#00bf53] font-medium">
                        +8% this week
                      </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 relative overflow-hidden">
                  <div className="absolute top-4 left-4 text-xs font-medium opacity-80 text-gray-900">
                    Future-Ready Skill Spotlight
                  </div>
                  <div className="absolute top-4 right-4 bg-gray-200 text-gray-900 px-2 py-1 rounded-2xl text-xs font-medium">
                    🔥 Top Pick
                  </div>
                  <h1 className="text-xl font-bold mt-6 mb-2 text-gray-900">
                    Top 1% Careers: Machine Learning Specialist
                  </h1>
                  <div className="space-y-1 mb-3 text-sm text-gray-700">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Demand across FinTech, EdTech, HealthTech, SaaS
                      </span>
                    </div>
                  </div>
                  <p className="text-xs text-gray-600 mb-4">
                    ML Specialists are leading AI automation, predictive
                    analytics, and next-gen product intelligence.
                  </p>
                  ...
                  <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
                    <p>
                      Welcome to your smart learning space — a personalised hub
                      built to understand how you learn, what you need, and how
                      fast you're growing.
                    </p>
                    <p>
                      Your dashboard brings every course, skill, goal, and
                      activity into one unified view so you can clearly track
                      your progress without confusion. Stay consistent with
                      daily learning targets, timely reminders for live classes,
                      and structured learning paths designed to help you build
                      habits that actually stick.
                    </p>
                    <p>
                      Our AI continuously analyses your performance, identifies
                      patterns, and gives you deep progress insights — showing
                      not just what you learned but how you're improving over
                      time. Push your limits with weekly challenges, interactive
                      quizzes, micro-tasks, and real-time competitions with
                      learners across India. Compete, collaborate, and grow as
                      you unlock achievements and climb your learning
                      leaderboard.
                    </p>
                    <p>
                      Your dashboard also highlights your strengths and skill
                      gaps, recommends the exact topics to focus on next, and
                      maps your journey to the career path you're aiming for.
                      You'll always know what to learn, why it matters, and how
                      it brings you one step closer to your goals.
                    </p>
                    <p>
                      Join a growing community of learners, mentors, and
                      industry experts who share knowledge, answer your
                      questions, and help you stay motivated throughout your
                      journey.
                    </p>
                  </div>
                  ...
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div
                      className="w-2 h-2 bg-green-400 rounded-full absolute animate-float-up"
                      style={{ right: "10%", animationDelay: "0s" }}
                    ></div>
                    <div
                      className="w-1.5 h-1.5 bg-green-300 rounded-full absolute animate-float-up"
                      style={{ right: "20%", animationDelay: "0.8s" }}
                    ></div>
                    <div
                      className="w-2.5 h-2.5 bg-green-500 rounded-full absolute animate-float-up"
                      style={{ right: "15%", animationDelay: "1.6s" }}
                    ></div>
                    <div
                      className="w-1 h-1 bg-green-200 rounded-full absolute animate-float-up"
                      style={{ right: "25%", animationDelay: "2.4s" }}
                    ></div>
                    <div
                      className="w-2 h-2 bg-green-400 rounded-full absolute animate-float-up"
                      style={{ right: "8%", animationDelay: "3.2s" }}
                    ></div>
                    <div
                      className="w-1.5 h-1.5 bg-green-300 rounded-full absolute animate-float-up"
                      style={{ right: "30%", animationDelay: "4s" }}
                    ></div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4 ">
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200 mb-20">
                    ...
                    <div className="mb-2">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs font-medium text-[#00bf53]">
                          65%
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-1">
                        <div
                          className="bg-[#00bf53] h-1 rounded-full"
                          style={{ width: "65%" }}
                        ></div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-3">
                      {currentSessions.map((session) => (
                        <div
                          key={session.id}
                          className={`w-12 h-10 border rounded flex items-center justify-center text-xs font-medium ${getSessionStyle(
                            session.status
                          )}`}
                        >
                          {session.id}
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-gray-500">
                        {Math.floor(Math.random() * 200) + 800} learners online
                      </span>
                    </div>
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <p className="text-sm text-gray-900">
                              ...
                              {activity.action}{" "}
                              <span className="text-[#00bf53] font-medium">
                                {activity.target}
                              </span>
                            </p>
        ...
        {activeTab === "weekly-challenge" && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600">
              Take on exciting coding challenges...
            </p>
          </div>
        )}
      </div>

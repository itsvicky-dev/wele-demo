...
const careerQuestions: MCQQuestion[] = [
  ...
  {
    id: "2",
    question: "You see a new product advertisement. What catches your attention first?",
    options: [
  ...
  {
    id: "4",
    question: "You receive a long message with lots of details. How do you handle it?",
    options: [
  ...
  {
    id: "6",
    question: "You have to choose between two similar items. What helps you decide?",
    options: [
  ...
  {
    id: "11",
    question: "You notice something is not working properly. What do you see first?",
    options: [
  ...
  {
    id: "12",
    question: "You're helping a friend solve a small issue. What do you focus on?",
    options: [
  ...
  {
    id: "21",
    question: "Your mixie suddenly stops while running. What do you check first?",
    options: [
  ...
  {
    id: "22",
    question: "Your laptop becomes slow only on some days. What seems most sensible to check?",
    options: [
  ...
  {
    id: "27",
    question: "You check your step count for a week and see one day is unusually high. What will you do?",
    options: [
  ...
  {
    id: "28",
    question: "A shop sells more snacks on rainy days. What seems most useful to know?",
    options: [
  ...
  {
    id: "29",
    question: "A friend wants to understand why their marks drop sometimes. What will you check first?",
    options: [
  ...
  {
    id: "30",
    question: "You have 20 photos of a product. What helps you describe it better?",
    options: [
  ...
  {
    id: "31",
    question: "Your bike uses more petrol during certain weeks. What will you think about?",
    options: [
  ...
  {
    id: "32",
    question: "A YouTube video gets more views on weekends. What can you guess?",
    options: [
  ...
  {
    id: "33",
    question: "You need to explain a difficult idea to a friend. What do you do?",
    options: [
  ...
  {
    id: "34",
    question: "You have two objects that don't seem related. How do you understand their connection?",
    options: [
      { id: "a", text: "Think of a creative purpose they could serve together" },
  ...
  {
    id: "35",
    question: "You see clouds moving in a strange pattern. What is your first thought?",
    options: [
  ...
  {
    id: "36",
    question: "You hear that a new rule is introduced at school/office. What do you try to understand?",
    options: [
  ...
  {
    id: "37",
    question: "You must reach a place but your usual route is blocked. What do you do?",
    options: [
  ...
  {
    id: "38",
    question: "You are given a task but the usual method isn't working. What is your approach?",
    options: [
  ...
  {
    id: "39",
    question: "You are filling out a form and notice two spellings of your name in different places. What will you do?",
    options: [
  ...
  {
    id: "40",
    question: "Your friend gives you a list of items to buy: \"Milk, Bread, Milk, Eggs.\" What do you do?",
    options: [
  ...
  {
    id: "41",
    question: "You plug your phone into a charger and hear a spark sound. What is the safest action?",
    options: [
  ...
  {
    id: "42",
    question: "Your younger sibling is trying to use scissors too close to their face. What do you do?",
    options: [
  ...
  {
    id: "43",
    question: "Your teacher gives a class rule: submit homework before 8 PM. What will you do?",
    options: [
  ...
  {
    id: "44",
    question: "You are arranging books on a shelf. What method will you follow?",
    options: [
      { id: "a", text: "Arrange them by size or category and follow the same pattern" },
  ...
  {
    id: "45",
    question: "Your friend tries a new app but gets confused while using it. What do you do first?",
    options: [
  ...
  {
    id: "46",
    question: "An elderly person finds it difficult to read text on a phone. What is the most helpful first step?",
    options: [
  ...
  {
    id: "47",
    question: "You notice two shops: one crowded and one empty. What will you check first?",
    options: [
  ...
  {
    id: "48",
    question: "Your friend says a website \"feels messy.\" What would you look at to understand why?",
    options: [
  ...
  {
    id: "49",
    question: "Someone keeps pressing the wrong button on a remote. What is the best first thought?",
    options: [
  ...
  {
    id: "50",
    question: "A visitor tries to open a door by pulling, but it needs to be pushed. What makes the most sense?",
    options: [
  ...
  {
    id: "51",
    question: "You open your refrigerator and notice one item looks slightly different from yesterday. What do you do first?",
    options: [
  ...
  {
    id: "52",
    question: "Your water bottle leaks a few drops only when you keep it sideways. What seems the best step?",
    options: [
  ...
  {
    id: "53",
    question: "You receive a remote with several buttons. How will you check if it works properly?",
    options: [
  ...
  {
    id: "54",
    question: "Your lamp sometimes flickers when switched on. What will you do?",
    options: [
  ...
  {
    id: "55",
    question: "You need to prepare tea for 5 people. What is the best way to ensure it comes out the same every time?",
    options: [
      { id: "a", text: "Follow the same order and same amount of ingredients each time" },
  ...
  {
    id: "56",
    question: "You have to check 20 notebooks for signatures. How will you complete the task?",
    options: [
      { id: "a", text: "Check them one by one in the same order to avoid missing any" },
  ...
  {
    id: "57",
    question: "You and your friends need to complete a group poster, but everyone is doing different parts randomly. What will you do first?",
    options: [
  ...
  {
    id: "58",
    question: "Your family is preparing for a small event, and tasks are getting mixed up. What seems most useful?",
    options: [
  ...
  {
    id: "59",
    question: "You have to travel tomorrow morning. What is the best way to prepare?",
    options: [
      { id: "a", text: "Pack your things and plan your route the night before" },
  ...
  {
    id: "60",
    question: "You want to study three chapters, but time is limited. What will you do?",
    options: [
      { id: "a", text: "Plan which chapter to do first and how much time to spend" },
  ...
  {
    id: "61",
    question: "You have to do laundry, finish homework, and meet a friend. What will you do first?",
    options: [
  ...
  {
    id: "62",
    question: "You receive many WhatsApp messages at once. How will you respond?",
    options: [
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "To store values that may change while the program runs" },
  ...
  {
    id: "65",
    question: "You write a program and it shows an error. What is the BEST first step?",
    options: [
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "It makes the code more readable and helps avoid mistakes" },
  ...
  {
    id: "68",
    question: "You want to repeat an action exactly 10 times. What should you use?",
    options: [
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "To group related steps together so you can reuse them" },
  ...
  {
    id: "71",
    question: "Your program runs but gives the wrong answer. What should you check?",
    options: [
              ...
              <div className="flex items-start space-x-3">
                <div className="flex-1">
                  <p className="text-gray-800 mb-4">
                    Welcome to Career Compass! I'll help you find the best
                    career path by asking a few questions.
                  </p>
                  <button
                    onClick={() => setShowAssessment(true)}
                    className="px-4 py-2 rounded-lg border border-[#00BF53] text-[#00BF53] hover:bg-[#00BF53]/[0.1] transition-colors"
                  >
                ...
                <div className="flex items-start space-x-3">
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      className="mt-6 bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
                    >
